        ...
        <form id="form">
           ...
           <div class="form-row submit-btn">
            <div class="centre">
               <div class="input-data">
                  <div class="inner"></div>
                  <input @click.prevent="loginUser" readonly value="ВОЙТИ">
               </div>
            </div>
           </div>
        </form>
...
export default {
    ...
    methods: {
        ...
        async loginUser() {
            var validateState = this.validateFormData();

            if(validateState !== true) {
                this.error = validateState;
            ...
            const res = await fetch("http://localhost:5099/login", {
                method: "POST",
